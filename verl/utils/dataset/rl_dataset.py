...
class RLHFDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        if self.processor is not None and ("Qwen2VLImageProcessor" in self.processor.image_processor.__class__.__name__ or "Qwen3VLImageProcessor" in self.processor.image_processor.__class__.__name__):
