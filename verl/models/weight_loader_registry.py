...
def get_weight_loader(arch: str, noise_config=None):
    from verl.models.mcore.loader import load_state_dict_to_megatron_gptmodel
    from verl.models.mcore.noisy_loader import load_state_dict_to_megatron_gptmodel_with_noise
    ...
    if arch in _MODEL_WEIGHT_MEGATRON_LOADER_REGISTRY:
        loader = _MODEL_WEIGHT_MEGATRON_LOADER_REGISTRY[arch]
        return loader
