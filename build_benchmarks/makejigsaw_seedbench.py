...
JIGSAW_SIZE = 5 # JIGSAW_SIZE x JIGSAW_SIZE patchess
...
def process_split(base: datasets.Dataset, prefix: str, min_size: int = 28):
    ...
    save_dir = f"datasets/SEEDBench_JigsawQA_{JIGSAW_SIZE}x{JIGSAW_SIZE}"
...
if __name__ == '__main__':
    ...
    print(f"Completed processing seedbench")