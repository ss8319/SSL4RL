...
if __name__ == '__main__':
    ...
    source_path = "datasets/MME-RealWorld-Lite"
    logger(f'!! Use {source_path} as data dir; it must be the unzipped version of '
        'https://huggingface.co/datasets/yifanzhang114/MME-RealWorld-Lite/resolve/main/data.zip?download=true')
    target_path = "datasets/MMERealWorld-Lite_ContrastiveQA"
