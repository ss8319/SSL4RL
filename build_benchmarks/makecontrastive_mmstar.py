    ...
    def generate_pairs():
        ...
        for dtmid, datum in enumerate(tqdm.tqdm(base, desc='Positive Pairs')):
            ...
            try:
                ...
                pospair = {
                    'index1': datum['index'],
                    'meta_info1': datum['meta_info'],
                    'height1': im1.height,
                    'width1': im1.width,
                    'index2': datum['index'],
                    'meta_info2': datum['meta_info'],
                    'height2': im2.height,
                    'width2': im2.width,
                    'images': [im1, im2],
        ...
        while neg_count < target_neg_samples:
            ...
            try:
                ...
                negpair = {
                    'index1': datum1['index'],
                    'meta_info1': datum1['meta_info'],
                    'height1': im1.height,
                    'width1': im1.width,
                    'index2': datum2['index'],
                    'meta_info2': datum2['meta_info'],
                    'height2': im2.height,
                    'width2': im2.width,
                    'images': [im1, im2],
                    'query': QUERY_TEMPLATE,
...
if __name__ == '__main__':
    ...
    source_path = "datasets/MMStar"
    target_path = "datasets/MMStar-Contrastive-maxcrop03"
